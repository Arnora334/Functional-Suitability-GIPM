...
TestObject emailField = findTestObject('Page_- GiPM/input_border rounded px-3 py-2 w-full_2')

// Isi email tidak valid
WebUI.setText(emailField, 'client1test.com')
...
// Ambil pesan validasi browser
String validationMsg = WebUI.getAttribute(emailField, 'validationMessage')
...
WebUI.verifyTextNotPresent('client1test.com', false)
