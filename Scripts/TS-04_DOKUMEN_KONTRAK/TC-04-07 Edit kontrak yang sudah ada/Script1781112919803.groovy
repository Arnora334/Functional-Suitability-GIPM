...
WebUI.setText(findTestObject('Page_- GiPM/input_border rounded px-3 py-2 w-full'), 'KONTRAK-001-EDIT')

WebUI.click(findTestObject('Page_- GiPM/button_Update Kontrak'))

WebUI.verifyTextPresent('KONTRAK-001-EDIT', false)
