...
WebUI.selectOptionByValue(findTestObject('Contract/Page_- GiPM/select_Pilih User -AliArnoraArnorDepArnoraUserAr'), '5',
	false)

WebUI.selectOptionByValue(findTestObject('Contract/Page_- GiPM/select_Pilih Project -Sistem Informasi Desa XSis'), '20', 
    false)

WebUI.setText(findTestObject('Contract/Page_- GiPM/input_border rounded px-3 py-2 w-full'), 'KONTRAK-002')
...
WebUI.verifyTextNotPresent('KONTRAK-002', false)
