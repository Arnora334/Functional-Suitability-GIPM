...
WebUI.setEncryptedText(findTestObject('Profile/Page_Log in - GiPM/input_Password'), 'z/uldadSn79nKKsjFnA9rg==')
...
WebUI.verifyTextPresent('The password is incorrect.', false)
