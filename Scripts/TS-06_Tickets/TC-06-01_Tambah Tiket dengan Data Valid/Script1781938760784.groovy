...
WebUI.selectOptionByValue(findTestObject('Tickets/Page_- GiPM/select_Pilih Project -Sistem Monitoring Inventar'), '23', 
    false)

WebUI.setText(findTestObject('Tickets/Page_- GiPM/input_border rounded px-3 py-2 w-full'), 'Penambahan Fitur Remember Me')

WebUI.setText(findTestObject('Tickets/Page_- GiPM/textarea_border rounded px-3 py-2 w-full'), 'Sistem memerlukan fitur Remember Me agar pengguna tidak perlu login ulang setiap kali membuka aplikasi.')
