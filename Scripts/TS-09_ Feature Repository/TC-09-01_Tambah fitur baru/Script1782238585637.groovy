...
WebUI.setText(findTestObject('Feature Repository/Page_- GiPM/input_Nama Fitur'), 'Manajemen Tiket Proyek')

WebUI.setText(findTestObject('Feature Repository/Page_- GiPM/input_Deskripsi'), 'Fitur untuk mengelola tiket perubahan proyek')
...
WebUI.verifyTextPresent('Manajemen Tiket Proyek', false)
