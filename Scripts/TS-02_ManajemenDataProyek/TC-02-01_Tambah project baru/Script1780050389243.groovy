...
WebUI.click(findTestObject('Page_- GiPM/label_Arnora'))

WebUI.click(findTestObject('Page_- GiPM/label_ArnorDev'))

WebUI.click(findTestObject('Page_- GiPM/label_ArnoraUser'))

WebUI.setText(findTestObject('Page_- GiPM/input_w-full border rounded px-3 py-2'), 'Sistem Manajemen Proyek Test Berbasis Web')
...
WebUI.setText(findTestObject('Page_- GiPM/input_w-full border rounded px-3 py-2_2'), 'Pengembangan sistem manajemen proyek berbasis web untuk monitoring')
